...
<Split img={signup1} alt="Step 1 of 2, Create Account: email address, password, and country, with Continue with Google and Continue with Apple below.">
...
<Split img={signup3} alt="Check your email: six single-digit boxes for the verification code, with a resend link and a 59-second expiry.">
